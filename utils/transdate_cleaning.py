...
df_csv['TransDate:'] = pd.to_datetime(df_csv['TransDate:'])
df_excel['TransDate:'] = pd.to_datetime(df_excel['TransDate:'])

# Filter for dates on or after 10/27/2024
filtered_csv = df_csv[df_csv['TransDate:'] >= '10/27/24']
filtered_excel = df_excel[df_excel['TransDate:'] >= '10/27/24']
